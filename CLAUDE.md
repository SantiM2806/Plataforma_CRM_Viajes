...
Falta Fase 1/2: página pública `/p/<token>` (propuesta interactiva + aprobación cliente), PDF, worker BullMQ (TRM diaria, búsquedas pesadas). Pendiente global: OAuth Google real (credenciales), LiteAPI key para probar búsqueda real, tests automatizados en CI.
