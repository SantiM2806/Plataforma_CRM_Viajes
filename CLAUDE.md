...
Falta Fase 1/2: PDF de la cotización, worker BullMQ (TRM diaria, búsquedas pesadas). Fase 3: CRM/reservas. Pendiente global: OAuth Google real (credenciales), LiteAPI key para probar búsqueda real, tests automatizados en CI.
