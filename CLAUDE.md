...
Falta: worker BullMQ (TRM diaria, búsquedas pesadas), Inbox omnicanal (Fase 4), Reportería/conciliación (Fase 5). Pendiente global: OAuth Google real (credenciales), LiteAPI key en `.env.local` para búsqueda real, tests automatizados en CI.
