...
Falta: worker BullMQ (TRM diaria automática, búsquedas LiteAPI pesadas), CI/CD + Dockerfile worker. Pendiente global: OAuth Google real, LiteAPI key privada (sand_), tests automatizados.
